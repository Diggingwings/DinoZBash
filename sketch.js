...
function draw(){
   ...
   text("Health  " + score1, 1300, 50)
    ...
    textSize(35)
    fill("#ADD8E6")
    text("Use space to reset  ", 600, 50)
...
score1=score1+1
 ...
 if(rocket2.isTouching(dino2)){
  ...
  if(keyDown("O")){
    ...
    explosion3.velocityX=-5
    explosion3.scale=0.3
    explosion2.x=explosion3.x
    explosion2.y=explosion3.y
...
if(rocket2.isTouching(dino1)){
  ...
  if(keyDown("E")){
    ...
    explosion1I.velocityX=5
    explosion1I.scale=0.3
     explosion4.x=explosion1I.x
    explosion4.y=explosion1I.y
